...
import Testimonials from "../Components/Testimonials"; // Import the existing testimonial component
...
const Services = ({ stats, serviceCards, projects, stack }) => {
  return (
    <div className="page">
      {/* Hero Section */}
      <section
      ...
      >
        <div className="hero__inner container">
          ...
          <p className="hero__subtitle">
            Transform your digital presence with cutting-edge 3D web
            development, immersive experiences, and innovative design solutions.
          </p>
        ...
        <div className="container">
          <div className="section__header">
            ...
            <p className="section__lead">
              We leverage cutting-edge technologies and proven methodologies to
        ...
        <div className="container">
          <div className="section__header">
            ...
            <p className="section__lead">
              ...
              expertise in creating innovative digital solutions for businesses
              worldwide.
            </p>
          </div>
      ...
      <section id="stack" className="section">
        <div className="container">
          <div className="section__header">
            ...
            <p className="section__lead">
              We utilize industry-leading technologies and frameworks to build
              robust, scalable, and high-performance web applications.
            </p>
          </div>
